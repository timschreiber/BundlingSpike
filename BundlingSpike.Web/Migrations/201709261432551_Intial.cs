namespace BundlingSpike.Web.Migrations
{
    ...
    public partial class Intial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Bundles", "SiteId", "dbo.Sites");
            DropForeignKey("dbo.Files", "BundleId", "dbo.Bundles");
            ...
            DropIndex("dbo.Files", new[] { "BundleId" });
            DropIndex("dbo.Bundles", new[] { "SiteId" });
